...
module ControlFile =
    ...
    let toJson (c: ControlFile) : string =
        ...
        if not (List.isEmpty c.Comments) then
            ...
            for m in c.Comments do
                ...
                if m.Kind = Name || m.Kind = Range then
    ...
    let fromJson (text: string) : ControlFile =
        ...
        let prop (k: string) : obj =
            emitJsExpr (root, k) "($0[$1] === undefined ? null : $0[$1])"
            ...
            | e ->
                [ let n: int = emitJsExpr e "$0.length"
                  ...
                  for i in 0 .. n - 1 do
                      ...
                      let get (k: string) : obj =
                          emitJsExpr (bo, k) "($0[$1] === undefined ? null : $0[$1])"
            ...
            | e ->
                [ let n: int = emitJsExpr e "$0.length"
                  ...
                  for i in 0 .. n - 1 do
                      ...
                      let get (k: string) : obj =
                          emitJsExpr (mo, k) "($0[$1] === undefined ? null : $0[$1])"
                      ...
                      let idx =
                          match get "instrIndex" with
                          | null -> -1
                          | v -> unbox<int> v

                      let endE =
                          match get "endExcl" with
                          | null -> 0
                          | v -> unbox<int> v
