...
import { Record } from "../fable_modules/fable-library-js.5.17.2/Types.js";
import { record_type, int32_type, string_type } from "../fable_modules/fable-library-js.5.17.2/Reflection.js";
import { max, min } from "../fable_modules/fable-library-js.5.17.2/Double.js";
import { split, printf, toText, join, substring } from "../fable_modules/fable-library-js.5.17.2/String.js";
import { item, map } from "../fable_modules/fable-library-js.5.17.2/Array.js";
...
function subst(ixName, d, withDisp, text) {
    ...
    if (idx < 0) {
        ...
        }, split(substring(text, idx + 1), [","], undefined, 0)));
    }
}
    ...
    switch (op) {
        ...
        case 253: {
            ...
            switch (inner) {
                ...
                default: {
                    const withDisp = usesHlMem(inner);
                    const len = ((baseLen(inner) + (withDisp ? 1 : 0)) + 1) | 0;
                    return new Insn(renderBase(get$, pc + 1, [name, s8(get$(pc + 2)), withDisp]), len);
                }
            }
        }
        case 237: {
