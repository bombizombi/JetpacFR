...
export function step(m) {
    ...
    switch (op) {
        case 203: {
            const matchValue_7 = item(~~item((pc + 1) & 65535, Machine__get_Memory(m)), cb);
        ...
        case 221: {
            ...
            switch (second) {
                case 203: {
                    const matchValue = item(~~item((pc + 3) & 65535, Machine__get_Memory(m)), dd_cb);
                    if (matchValue == null) {
                        toFail(printf("no code at 0x%04X"))(pc);
                    }
                    else {
                ...
                case 237:
                case 253: {
                    const matchValue_1 = item(second, dd);
                ...
                default: {
                    const matchValue_2 = item(second, dd);
        ...
        case 237: {
            const matchValue_6 = item(~~item((pc + 1) & 65535, Machine__get_Memory(m)), ed);
        ...
        case 253: {
            ...
            switch (second_1) {
                case 203: {
                    const matchValue_3 = item(~~item((pc + 3) & 65535, Machine__get_Memory(m)), fd_cb);
                ...
                case 237:
                case 253: {
                    const matchValue_4 = item(second_1, fd);
                ...
                default: {
                    const matchValue_5 = item(second_1, fd);
        ...
        default: {
            const matchValue_8 = item(op, main);
