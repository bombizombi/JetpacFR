...
module Z80Decode =
    ...
    let rows: Row list =
        [ { Prefix = [| 0xdduy; 0xcbuy; 0x00uy; 0x06uy |]
            ...
            Format =
              (fun img pc ->
                  "Z80Vocab.RLC_PTR_IXd"
                  + (if 1 = 0 then
                         ""
                     else
                         " " + (sprintf "%d" (sbyte img[pc + 2]))))
            LabelName = None }
            ...
            Format =
              (fun img pc ->
                  ...
                  + (if 1 = 0 then
                         ...
                         " " + (sprintf "0x%04X" ((int img[pc + 2]) ||| ((int img[pc + 3]) <<< 8)))))
            LabelName = None }
          ...
          { Prefix = [| 0xdduy; 0x36uy; 0x00uy; 0x00uy |]
            ...
            Format =
              (fun img pc ->
                  "Z80Vocab.LD_PTR_IXd_n"
                  + (if 2 = 0 then
                         ""
                     else
                         " "
                         + (sprintf "%d" (sbyte img[pc + 2]) + " " + sprintf "0x%02X" (int img[pc + 3]))))
            LabelName = None }
            ...
            Format =
              (fun img pc ->
                  ...
                  + (if 1 = 0 then
                         ...
                         " " + (sprintf "0x%04X" ((int img[pc + 1]) ||| ((int img[pc + 2]) <<< 8)))))
            LabelName = None }
