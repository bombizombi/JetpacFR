    ...
    let main: (Machine -> unit) option[] =
        [| Some(fun (m: Machine) -> m.Fetch())
           ...
           Some(fun (m: Machine) ->
               ...
               let struct (r, f) =
                   Alu.add8 (m.Regs.Get R8.A) (m.Read(m.Regs.Wz())) (m.Flags()).carry
           ...
           Some(fun (m: Machine) ->
               ...
               let struct (r, f) =
                   Alu.sub8 (m.Regs.Get R8.A) (m.Read(m.Regs.Wz())) (m.Flags()).carry
    ...
    let ed: (Machine -> unit) option[] =
        [| Some(fun (m: Machine) ->
           ...
           Some(fun (m: Machine) ->
               ...
               let struct (r, f) =
                   Alu.adc16 (m.Regs.Get R16.HL) (m.Regs.Get R16.BC) (m.Flags()).carry
           ...
           Some(fun (m: Machine) ->
               ...
               let struct (r, f) =
                   Alu.sbc16 (m.Regs.Get R16.HL) (m.Regs.Get R16.HL) (m.Flags()).carry
           ...
           Some(fun (m: Machine) ->
               ...
               let struct (r, f) =
                   Alu.adc16 (m.Regs.Get R16.HL) (m.Regs.Get R16.SP) (m.Flags()).carry
